...
describe('native Tiptap collaboration document', () => {
  ...
  it('round-trips image, file, callout and toggle blocks through Yjs', () => {
    ...
    migrateHtmlToNativeFragment(source, `
      ...
      <img src="notetodo-asset://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/cover.png" data-preview-src="notetodo-asset://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/cover.png?variant=thumbnail" data-width="75" data-caption="季度发布封面" alt="Cover">
    ...
    expect(json.content?.[2]?.attrs).toMatchObject({ width: 75, caption: '季度发布封面' })
