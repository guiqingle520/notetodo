...
export interface PageTemplate {
  id: 'blank' | 'meeting' | 'project' | 'weekly' | 'database'
  name: string
  description: string
  icon: PageIcon
  content: string
...
export const pageTemplates: PageTemplate[] = [
  ...
  { id: 'database', name: '整页数据库', description: '像 Notion 一样独立管理结构化资料', icon: 'grid', content: '<p data-notetodo-page-layout="database"></p>' },
]
