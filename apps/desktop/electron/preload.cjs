...
contextBridge.exposeInMainWorld('notetodo', {
  ...
  database: {
    ...
    duplicateRecord: (databaseId, sourceRecordId, recordId) => ipcRenderer.invoke('database:duplicate-record', databaseId, sourceRecordId, recordId),
    trashRecords: (databaseId, recordIds) => ipcRenderer.invoke('database:trash-records', databaseId, recordIds),
    listTrashedRecords: (databaseId) => ipcRenderer.invoke('database:list-trashed-records', databaseId),
    ...
    listRecordComments: (recordId, unresolvedOnly) => ipcRenderer.invoke('database:list-record-comments', recordId, unresolvedOnly),
    createRecordComment: (comment) => ipcRenderer.invoke('database:create-record-comment', comment),
    resolveRecordComment: (id, resolved) => ipcRenderer.invoke('database:resolve-record-comment', id, resolved),
    deleteRecordComment: (id) => ipcRenderer.invoke('database:delete-record-comment', id),
    listRecordReminders: (recordId) => ipcRenderer.invoke('database:list-record-reminders', recordId),
    listDueRecordReminders: () => ipcRenderer.invoke('database:list-due-record-reminders'),
    saveRecordReminder: (reminder) => ipcRenderer.invoke('database:save-record-reminder', reminder),
    completeRecordReminder: (id, completed) => ipcRenderer.invoke('database:complete-record-reminder', id, completed),
    deleteRecordReminder: (id) => ipcRenderer.invoke('database:delete-record-reminder', id),
    ...
    importRecords: (databaseId, records) => ipcRenderer.invoke('database:import-records', databaseId, records),
